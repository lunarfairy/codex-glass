...
- [x] **Step 3: Restore the minimal launcher**
...
- [x] **Step 1: Define the failing manual case**
...
- [x] **Step 2: Add the pre-install requirement check**
...
- [x] **Step 3: Verify the missing-CLI case**
...
- [x] **Step 4: Verify a real CLI and upgrade cleanup**
...
- [x] **Step 5: Commit the installer change**
...
- [x] **Step 1: Make the release builder require no CLI parameter**
...
- [x] **Step 2: Update the user-facing prerequisites**
...
- [x] **Step 5: Commit the release change**
...
- [x] **Step 2: Verify the actual ZIP from a Unicode path**
